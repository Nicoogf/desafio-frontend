  ...
  return (
    <main className='relative z-50 w-full bg-gray-900 h-[calc(100vh-40px)] max-w-[1920px] rounded-md flex items-center justify-center'>
      ...
      {(validationErrors.length > 0) ? (
        <div className={`w-[100%] max-w-[450px] shadow-xl absolute top-0 bg-slate-950 text-center transition-all duration-500 translate-y-0 py-4 border-2 border-red-800 rounded-t-md`}>
        ...
        <div className={`w-[100%] max-w-[450px] shadow-xl absolute top-0 bg-red-700 text-center transition-all duration-500 -translate-y-48`}>
      ...
      <form onSubmit={onSubmit}
        ...
        ${mailValidate ? "-translate-y-56 opacity-0"
          ...
          <button className='mt-4 bg-greenlime w-[60%] p-2 rounded-md text-lime-950 mx-auto font-semibold border border-transparent hover:border-gray-950 hover:bg-slate-300 hover:text-gray-900 transition-all duration-100' onClick={setPassword}> Siguiente </button>
        </div>
        ...
        ${mailValidate ? "-translate-y-56 opacity-100"
          ...
          <div className='flex flex-row gap-x-2 w-[95%] mx-auto  justify-center mt-2'>
            <button className='text-sm my-4 bg-gray-900 border border-lime-500 p-2 rounded-md text-lime-500 font-semibold  border-transparent hover:border-gray-950 hover:bg-slate-300 hover:text-gray-900 transition-all duration-100' onClick={setPassword}> Modificar Email </button>
            <button className='my-4 bg-lime-400 p-2 rounded-md text-lime-950 font-semibold border border-transparent hover:border-gray-950 hover:bg-slate-300 hover:text-gray-900 transition-all duration-100' type='submit'> Siguiente </button>
          </div>
